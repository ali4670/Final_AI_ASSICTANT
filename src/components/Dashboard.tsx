...
const Dashboard: React.FC<DashboardProps> = ({ onNavigate }) => {
    ...
    const menuItems = [
        { id: 'public-docs', title: 'Public Grid', icon: Users, color: '#10b981', badge: 'Global', desc: 'Access and study from community shared knowledge nodes.' },
        { id: 'themes', title: 'Environments', icon: CloudRain, color: '#a855f7', badge: 'Immersive', desc: 'Customize your study atmosphere with smart themes.' },
        ...
        { id: 'marketplace', title: 'Neural Market', icon: ShoppingBag, color: '#ec4899', badge: 'Store', desc: 'Redeem stars for virtual assets and upgrades.' },
        { id: 'skill-tree', title: 'Skill Tree', icon: Network, color: '#3b82f6', badge: 'Growth', desc: 'Visualize your cognitive evolution and unlock perks.' },
        ...
        { id: 'ai-planner', title: 'AI Planner', icon: Sparkles, color: '#f59e0b', badge: 'Smart', desc: 'Auto-generate your weekly neural study roadmap.' },
        { id: 'summaryHub', title: 'Summary Hub', icon: BookOpen, color: '#a855f7', badge: 'Peer', desc: 'Explore peer-authored document summaries.' },
        { id: 'social', title: 'Social Hub', icon: Users, color: '#3b82f6', badge: 'Network', desc: 'Connect with students and share study materials.' },
